...
*/
//using ResNet = resnet::anet_type;


//class ResNet: private resnet::anet_type
//{
//public:
//    using OutputLabel = typename resnet::anet_type::output_label_type;
//
//    using resnet::anet_type::operator();
//
